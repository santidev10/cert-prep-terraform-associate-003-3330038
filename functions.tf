...
# num functions: abs, ceil, floor, log, max, min, parseint, pow, signum,
# string functions: chomp, endswith, format, formatlist, indent, join, , lower, upper, regex, regexall, replace, split, startswith, strcontains, strrev, , substr, tittle, trim, trimprefix, trimsuffix
